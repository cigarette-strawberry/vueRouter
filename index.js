...
const routes = [
...

  {
    ...
    // route level code-splitting 路线级代码拆分
    // this generates a separate chunk (about.[hash].js) for this route 这将为此路由生成一个单独的块
    // which is lazy-loaded when the route is visited. 当访问该路线时，其是惰性加载的
...
/* 
  VueRouter 传参方式 两种  路径传参(path,query)  query传参(name,params)
